...
export const auth = betterAuth({
  ...
  // Allow Vercel preview deployments, Netlify previews, and any subdomain
  // of the deployment hosts to issue OAuth requests (origin check would
  // otherwise 403 every sign-in from a preview URL that differs from baseURL).
  trustedOrigins: [
    "https://*.vercel.app",
    "https://*.vercel.com",
    "https://*.netlify.app",
